...
class AnalyticalReportPDF(FPDF):
    ...
    def header(self):
        ...
        # Divider line below logos/subheader
        ...
        # --- Additional banner under header (visible on every page) ---
        banner_y = y_line + 3
        banner_h = 6
...
def main():
    ...
    if chem_selected:
        with st.expander("🧪 Chemical analysis", expanded=True):
            st.caption("Add operator name + notes per method. Important for traceability.")
